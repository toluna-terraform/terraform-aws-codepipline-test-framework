...
phases:
  pre_build:
    commands:
      ...
      - wget http://apache.stu.edu.tw//jmeter/binaries/apache-jmeter-${jmeter_version}.tgz
  ...
  build:
    commands:
        ...
        - jmeter -n -t ${jmx_file_path} -JbaseUrl=$BASE_URL -Jtest_name=${app_name}-${env_type}.xml
  post_build:
    commands:
