...
import (
	...
	tools "github.com/toluna-terraform/terraform-test-library/modules/coverage"
...
func TestSetup(t *testing.T) {
	...
	tools.WriteConvergeFiles(t, configureTerraformOptions(t), moduleName)
}

func TestBucketExists(t *testing.T) {
	log.Println("Checking for test bucket")
	tools.MarkAsCovered("aws_s3_bucket_policy.postman_bucket", moduleName)
...
func TestTerraformTestLambda(t *testing.T) {
	...
	tools.MarkAsCovered("aws_lambda_function.test_framework", moduleName)
